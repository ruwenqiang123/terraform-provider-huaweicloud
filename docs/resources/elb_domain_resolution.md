...
The missing attributes include: `loadbalancer_id`, `public_domain_name_enable`, `private_domain_name_enable`,
`public_dns_zone_name`, `public_dns_record_set_ttl`, `private_dns_zone_name`, `private_dns_zone_type`,
...
resource "huaweicloud_elb_domain_resolution" "test" {
  ...
  lifecycle {
    ignore_changes = [
      loadbalancer_id, public_domain_name_enable, private_domain_name_enable, public_dns_zone_name,
      public_dns_record_set_ttl, private_dns_zone_name, private_dns_zone_type, private_dns_record_set_ttl,
    ]
  }
}
```
