...
layout: "huaweicloud"
page_title: "HuaweiCloud: huaweicloud_dcs_center_tasks"
description: |-
  Use this data source to query the list of DCS center tasks within HuaweiCloud.
---

# huaweicloud_dcs_center_tasks

Use this data source to query the list of DCS center tasks within HuaweiCloud.

## Example Usage

### Query all center tasks

```hcl
data "huaweicloud_dcs_center_tasks" "test" {}
```

### Query center tasks within a specific time range
...
* `region` - (Optional, String) Specifies the region where the DCS tasks are located.  
...
* `tasks` - The list of center tasks.  
  The [tasks](#dcs_center_tasks_task) structure is documented below.

<a name="dcs_center_tasks_task"></a>
The `tasks` block supports:

* `id` - The center task ID.

* `name` - The center task name.  
  Valid values are:
...
* `details` - The detailed information of the task.  
  The [details](#dcs_center_tasks_task_details) structure is documented below.
...
<a name="dcs_center_tasks_task_details"></a>
