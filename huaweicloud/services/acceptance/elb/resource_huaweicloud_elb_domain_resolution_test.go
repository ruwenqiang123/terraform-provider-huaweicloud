...
func getDomainResolutionResourceFunc(cfg *config.Config, state *terraform.ResourceState) (interface{}, error) {
	...
	return elb.GetDomainResolutionInformation(client, state.Primary.ID)
}
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet(resourceName, "ips.0.type"),
					resource.TestCheckResourceAttrSet(resourceName, "ips.0.enable"),
					resource.TestCheckResourceAttrSet(resourceName, "ips.0.ip_address"),
					resource.TestCheckResourceAttrSet(resourceName, "ips.0.domain_name"),
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet(resourceName, "ips.0.created_at"),
					resource.TestCheckResourceAttrSet(resourceName, "ips.0.updated_at"),
				),
			},
			{
